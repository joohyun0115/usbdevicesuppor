...
#include <linux/usb/f_accessory.h>
	...
	#define HKDKC110_UMS_PRODUCT_ID		0x0001
	#define HKDKC110_ADB_PRODUCT_ID		0x0002
	#define HKDKC110_RNDIS_PRODUCT_ID	0x0003
...
static struct android_usb_product usb_products[] = {
#if defined(CONFIG_HKDKC110_BOARD)
	{
		.product_id	= HKDKC110_UMS_PRODUCT_ID,
	...
	{
		.product_id = HKDKC110_RNDIS_PRODUCT_ID,
